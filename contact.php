...
if(
	...
	if (!filter_var($_POST['contact-email'], FILTER_VALIDATE_EMAIL) === false) {
		...
		if( isset( $_POST['contact-subject'] ) && $_POST['contact-subject'] != '' ) {	$msg .= "Subject: ".$_POST['contact-subject']."\r\n";	}
		if( isset( $_POST['contact-website'] ) && $_POST['contact-website'] != '' ) {	$msg .= "Website: ".$_POST['contact-website']."\r\n";	}
